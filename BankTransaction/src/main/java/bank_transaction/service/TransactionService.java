...
import bank_transaction.models.Account;
import bank_transaction.models.Transaction;
import bank_transaction.models.User;
...
public class TransactionService {
    ...
    public void acceptTransaction(Long transactionId, Long adminId) {
        ...
        if(transaction != null && admin != null) {
            if(admin.getRole().equals("ADMIN") && !transaction.getStatus().equals("cancelled")) {
